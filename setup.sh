...
# etc
wget -O /home/vps/public_html/client.ovpn "http://orangkuatsabahanterkini.tk/rendum/client.ovpn"
wget -O /etc/motd "https://raw.githubusercontent.com/unichip/unichip989/master/motd"
...
echo "OpenVPN  : TCP 1194 (sila dapatkan file ovpn dari OrangKuatSabahanTerkini)"  | tee -a log-install.txt
